    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-8 shadow-sm text-center">
        ...
        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
          Your account is authenticated, but does not possess administrator privileges for the EduEvents Portal. Please contact your platform administrator (e.g. <strong>admin@eduevents.in</strong>) to request access.
        </p>
        ...
        <div className="space-y-3">
          ...
          <div className="pt-2 border-t border-slate-100">
            <SignOutButton redirectUrl="/admin/sign-in">
              <button
                type="button"
                className="w-full h-11 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
