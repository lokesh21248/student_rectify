...
// Social icon SVGs (lucide doesn't export all brand icons reliably)
const TwitterIcon = () => (
      ...
      <div className="container-page pt-16 pb-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white text-lg tracking-tight">
                Edu<span className="text-blue-400">Events</span>
              </span>
            </Link>
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs mb-6">
              The premier platform for discovering and participating in college events across India. Connect, learn, and grow.
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} EduEvents. All rights reserved.
          </p>
